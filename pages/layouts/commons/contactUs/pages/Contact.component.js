        ...
        <div className="container mb-5">
          <div className="row">
            <div className="col-sm text-center">
              <h1 className="title my-5">Contact US</h1>
            </div>
          </div>
          <div className="row">
            <div className="col-md-6 px-5 form-idea">
              ...
              <form>
                ...
                <button type="submit" className="btn btn-lg btn-block">Submit</button>
              </form>
            </div>
            <div className="col-md-6">
              <h6 className="my-3 map-info">Address: <span className="text-muted">38 Yen Bai - Hai Chau - Da Nang</span></h6>
              <h6 className="my-3 map-info">Email: <span className="text-muted">nancy@gmail.com</span></h6>
              <h6 className="my-3 map-info">Contact: <span className="text-muted">+91 98766 10278 || +91 76689 14244</span></h6>
